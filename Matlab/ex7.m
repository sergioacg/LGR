...
theta = acosd(zeta); % Ángulo de la línea de amortiguamiento en grados
...
axis([-5 1.5 -4 4]); % Ajuste de los límites de los ejes para una mejor visualización

% Preasignación de la matriz de datos para almacenar los resultados
K_range = 0:0.01:10;
j = 1; %Indice de los datos encontrados
data = zeros(length(K_range), 3);
